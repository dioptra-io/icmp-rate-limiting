...
int main(int argc, char ** argv) {
    ...
    auto sniff_interface = "en7";
    // Parse options
    int c;
    IPv4Address before_address;
    ...
    constexpr auto nb_probes = 12000;
    // Probing rate represents the number of packets to send in 1 sec
    constexpr auto probing_rate = 3000;
    ...
    udp_direct_test.set_pcap_file("resources/udp_direct.pcap");
    ...
    // ICMP direct
    rate_limit_test_t<ICMP> icmp_direct_test(nb_probes, probing_rate, sniff_interface, destination, destination_alias1);
